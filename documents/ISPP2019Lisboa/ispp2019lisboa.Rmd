...
# ¿La información sobre desigualdad y pobreza influye en las creencias de oportunidades?
...
- Ítem de educación
- Verificaciones de conocimientos previos

---
##  Objetivo e Hipotesis

-  ** Objetivo ** : Examinamos si la exposición a información objetiva sobre desigualdad económica y pobreza afecta las creencias de oportunidad
...
-    Creencias de oportunidad: batería de ISSP, módulo de desigualdad social.

    -    ** Factores estructurales ** : a) provenientes de una familia rica y b) teniendo padres bien educados.

    -    ** Factores individuales ** : c) trabajo duro y d) ambición.

    -    También usamos el ítem e) tener una buena educación usted mismo.
...
-    **Métodos**
    ...
    -    Intento de tratar el efecto (ITT) con regresiones para variables dependientes ordinales.
...
2.   Registro del plan de preanálisis en OFS.
...
### ... ... también con la contribución de nuestros asistentes de investigación Julio Iturra y Constanza Ayala
